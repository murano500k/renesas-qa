...
export hpip="172.22.11.87"
export jeip="172.22.89.21"
...
alias munlock="sudo rm -f /tmp/LCK..ttyUSB*"
...
alias r0m='sudo phidget-lite-x86_64 -r3 -s0'
alias r1m='sudo phidget-lite-x86_64 -r3 -s1'
alias r0h='sudo phidget-lite-x86_64 -r1 -s0'
alias r1h='sudo phidget-lite-x86_64 -r1 -s1'
alias minih="minicom -D /dev/ttyUSB0"
alias minim="minicom -D /dev/ttyUSB1"
